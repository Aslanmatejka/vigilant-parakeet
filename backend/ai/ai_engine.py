...
def _build_action_policy() -> str:
    ...
    return (
        ...
        "  2) Guide me step by step — walk them through EACH field one "
        "question at a time entirely in chat. Do NOT open any page or call "
        "navigate_ui unless they explicitly ask ('open the page', 'take me "
        "there', 'show me the form'). Once all info is collected, offer to "
        "post it for them OR open the page so they can submit themselves.\n"
